...
CREATE VIEW [ott].[vw_Caregiver_test]
AS
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'ott', @level1type = N'VIEW', @level1name = N'vw_Caregiver_test';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'ott', @level1type = N'VIEW', @level1name = N'vw_Caregiver_test';
